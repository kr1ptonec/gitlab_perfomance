...
export default function() {
  group("API - Project Repository Commit Signature", function() {
    ...
    let res = http.get(`${__ENV.ENVIRONMENT_URL}/api/v4/projects/${__ENV.PROJECT_GROUP}%2F${projectName}/repository/commits/${__ENV.PROJECT_SIGNED_COMMIT_SHA}/signature`, params);
