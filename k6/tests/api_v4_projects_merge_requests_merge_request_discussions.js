...
export default function() {
  group("API - Merge Request Discussions", function() {
    ...
    let res = http.get(`${__ENV.ENVIRONMENT_URL}/api/v4/projects/${__ENV.PROJECT_GROUP}%2F${projectName}/merge_requests/${__ENV.PROJECT_MR_DISCUSSIONS_IID}/discussions`, params);
