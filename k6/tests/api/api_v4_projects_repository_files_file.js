...
export let projects = getLargeProjects(['encoded_path', 'file_source_path']);
...
export default function() {
  group("API - Project Repository File", function() {
    ...
    let res = http.head(`${__ENV.ENVIRONMENT_URL}/api/v4/projects/${project['encoded_path']}/repository/files/${project['file_source_path']}?ref=master`, params);
