...
export let projects = getLargeProjects(['name', 'group_path_api', 'branch']);
...
export default function() {
  group("API - Project Repository Branch Details", function() {
    ...
    let res = http.get(`${__ENV.ENVIRONMENT_URL}/api/v4/projects/${project['group_path_api']}%2F${project['name']}/repository/branches/${project['branch']}`, params);
