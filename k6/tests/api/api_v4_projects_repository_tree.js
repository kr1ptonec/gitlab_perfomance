...
export let projects = getLargeProjects(['encoded_path', 'dir_path']);
...
export default function() {
  group("API - Project Repository Tree", function() {
    ...
    let res = http.get(`${__ENV.ENVIRONMENT_URL}/api/v4/projects/${project['encoded_path']}/repository/tree?path=${project['dir_path']}`, params);
