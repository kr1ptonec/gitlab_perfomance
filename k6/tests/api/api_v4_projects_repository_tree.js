...
export let projects = getLargeProjects(['name', 'group_path_api', 'dir_path']);
...
export default function() {
  group("API - Project Repository Tree", function() {
    ...
    let res = http.get(`${__ENV.ENVIRONMENT_URL}/api/v4/projects/${project['group_path_api']}%2F${project['name']}/repository/tree?path=${project['dir_path']}`, params);
