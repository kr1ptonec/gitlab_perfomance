...
@example_uri: /api/v4/projects/:encoded_path/repository/files/:file_raw_path/raw?ref=master
...
export let projects = getLargeProjects(['encoded_path', 'file_raw_path']);
...
export default function() {
  group("API - Project Repository File Raw", function() {
    ...
    let res = http.get(`${__ENV.ENVIRONMENT_URL}/api/v4/projects/${project['encoded_path']}/repository/files/${project['file_raw_path']}/raw?ref=master`, params);
