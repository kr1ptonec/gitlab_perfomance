...
export default function() {
  group("API - Project Repository File Raw", function() {
    ...
    let res = http.get(`${__ENV.ENVIRONMENT_URL}/api/v4/projects/${project['group_path_api']}%2F${project['name']}/repository/files/${project['file_raw_path']}/raw?ref=master`, params);
