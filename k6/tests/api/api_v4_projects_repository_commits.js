...
import { apiRps, apiRpsThreshold, apiScenario } from "../../lib/gpt_scenarios.js";
...
export let options = {
  ...
  thresholds: {
    ...
    "http_reqs": [`rate>=${apiRpsThreshold}`],
  }
};
...
export function setup() {
  console.log(`API Protocol RPS: ${apiRps}/s`)
  console.log(`RPS Threshold: ${apiRpsThreshold}/s`)
