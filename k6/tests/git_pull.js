...
import { logError, getRpsThresholds, getStagesConfig } from "./modules/custom_k6_modules.js";

export let gitProtoRps = Math.ceil(parseFloat(__ENV.RPS_TARGET) * __ENV.GIT_ENDPOINT_THRESHOLD);
export let gitProtoStages = getStagesConfig(__ENV.GIT_ENDPOINT_THRESHOLD);
export let requestsInTest = 2;
export let rpsThresholds = getRpsThresholds(__ENV.GIT_ENDPOINT_THRESHOLD, requestsInTest);
