...
export default function() {
  group("API - Project Repository File", function() {
    ...
    let res = http.get(`${__ENV.ENVIRONMENT_URL}/api/v4/projects/${__ENV.PROJECT_GROUP}%2F${__ENV.PROJECT_NAME}/repository/files/${__ENV.PROJECT_FILE_PATH}?ref=master`, params);
