...
@description: Web - Project Merge Requests page. <br>Controllers: `Projects::MergeRequestsController`</br>
*/
...
export default function() {
  group("Web - Projects MergeRequests Controller Show HTML", function() {
    let project = selectProject(projects);

    let params = { headers: { "Cache-Control": "no-cache" } };
    let res = http.get(`${__ENV.ENVIRONMENT_URL}/${project['group']}/${project['name']}/merge_requests`, params);
