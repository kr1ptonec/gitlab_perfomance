...
export default function() {
  group("Web - Group Search", function() {
    ...
    scopes.forEach(scope => {
      ...
      let res = http.get(`${__ENV.ENVIRONMENT_URL}/search?scope=${scope}&group_id=${project['group_id']}&search=${searchTerm}`, {tags: {endpoint: scope, controller: 'SearchController', action: 'show'}, redirects: 0});
