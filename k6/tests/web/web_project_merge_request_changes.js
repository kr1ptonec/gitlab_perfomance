...
export let rpsThresholds = getRpsThresholds(__ENV.WEB_ENDPOINT_THRESHOLD * 0.1, endpointCount);
export let successRate = new Rate("successful_requests");
export let options = {
  thresholds: {
    "successful_requests": [`rate>${__ENV.SUCCESS_RATE_THRESHOLD}`],
    "http_req_waiting{endpoint:diffs}": ["p(95)<1200"],
    "http_req_waiting{endpoint:diffs.json}": ["p(95)<15000"],
