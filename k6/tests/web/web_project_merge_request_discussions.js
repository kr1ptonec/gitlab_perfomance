...
export let rpsThresholds = getRpsThresholds(__ENV.WEB_ENDPOINT_THRESHOLD * 0.7, endpointCount)
export let successRate = new Rate("successful_requests");
export let options = {
  thresholds: {
    "successful_requests": [`rate>${__ENV.SUCCESS_RATE_THRESHOLD}`],
    "http_req_waiting{endpoint:merge_request}": ["p(95)<500"],
    "http_req_waiting{endpoint:discussions.json}": ["p(95)<3500"],
    "http_req_waiting{endpoint:widget.json}": ["p(95)<500"],
