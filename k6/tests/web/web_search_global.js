...
export default function() {
  group("Web - Global Search", function() {
    ...
    scopes.forEach(scope => {
      let res = http.get(`${__ENV.ENVIRONMENT_URL}/search?scope=${scope}&search=${project['search'][scope]}`, {tags: {endpoint: scope, controller: 'SearchController', action: 'show'}});
