...
export default function() {
  group("API - Project Repository File Raw", function() {
    ...
    let res = http.get(`${__ENV.ENVIRONMENT_URL}/api/v4/projects/${__ENV.PROJECT_GROUP}%2F${projectName}/repository/files/${__ENV.PROJECT_FILE_PATH}/raw?ref=master`, params);
