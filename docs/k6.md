...
Out of the box all the k6 tests are configured to run against a GitLab environment that at least has one instance of the default Test Project setup (see [GitLab Performance Toolkit - Environment Preparation](environment_prep.md) for more info).
