...
```json
{
  ...
  "git_push_data": {
    "import_url": "https://gitlab.com/gpt-bot/performance.git",
...
* Git push data that will be used for git push test. To test a custom project or learn more about git push test, please refer to [`Git Push test documentation`](test_docs/git_push.md). The size of the project and commits should be tuned to your environment's requirements.
      * `import_url` - Repository URL that will be used to import the data to a new project.
