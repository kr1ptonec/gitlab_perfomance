...
Options:
  ...
  -o, --options=<s>        Path of Options Config file path that the tests should be run with. (Default: ./options/20s_2rps.json)
  -t, --tests=<s+>         Path of Test file or folder paths to run. (Default: ./tests)
  -c, --custom             Include any tests inside the k6/tests/custom folder when true.
  -s, --scenarios          Include any scenario tests inside the ./tests/scenarios folder when true.
...
Examples:
  Running all Tests with the 60s_200rps Options file against the 10k Environment:
    ./bin/run-k6 --environment ./k6/environments/10k.json --options ./k6/options/60s_200rps.json
  Run a specific Test with the 60s_200rps Options file against the 10k Environment:
    ./bin/run-k6 --environment ./k6/environments/10k.json --options ./k6/options/60s_200rps.json --tests ./k6/tests/api/api_v4_groups_projects.js
```
...
Saving all test results to ./k6/results/10k_20191101_143833
Running k6 test 'api_v4_projects_project' against environment '10k'...
  ...
  execution: local--------------------------------------------------]   servertor
     output: -
     script: k6/tests/api/api_v4_projects_project.js
...
./k6/results/10k_20191101_143833/10k_2019-11-01_14:38:33_results.json
./k6/results/10k_20191101_143833/10k_2019-11-01_14:38:33_results.txt
```
