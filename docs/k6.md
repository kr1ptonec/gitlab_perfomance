...
To get more detailed information about the current test list please see the [Current Test Details wiki page](https://gitlab.com/gitlab-org/quality/performance/wikis/current-test-details).
...
Running k6 test 'api_v4_groups_projects' against environment 'onprem'...
  ...
  execution: local--------------------------------------------------]   servertor
     output: -
     script: ./tests/api/api_v4_groups_projects.js
